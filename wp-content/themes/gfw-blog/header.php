      ...
      <div class="row">
        <div class="column">
          ...
          <?php elseif (is_category() && in_category( 'News roundups' )) : ?>
            <h1 class="title">GFW News roundups</h1>
